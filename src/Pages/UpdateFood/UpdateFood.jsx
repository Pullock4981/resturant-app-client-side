    ...
    return (
        <div>
            <div className='mx-4 md:mx-16'>
                ...
                <form className='my-10' onSubmit={handleUpdateFood}>
                    ...
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4 mb-6">
                        ...
                        <textarea name='description' defaultValue={foodItem.description} rows="4" className="textarea w-full border border-[#8A4771]" placeholder="Include ingredients, preparation method, etc." required></textarea>
                    </fieldset>
