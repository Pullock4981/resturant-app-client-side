...
//                                     <Link to={`/foodDetails/${food._id?.$oid || food._id}`} className="btn btn-outline text-[#8D4974] hover:bg-[#8D4974] hover:text-white">View Details</Link>
//                                 </div>
//                             </div>
//                         </div>
//                     ))
...
// import { Link, useLoaderData } from 'react-router-dom'; // use `react-router-dom` instead of `react-router`
// import { AuthContext } from '../../Contexts/AuthContext';
