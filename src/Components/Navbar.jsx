        ...
        <div className="navbar lg:px-28 text-gray-200 shadow-sm bg-[#37324C]">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        tabIndex={0}
                        className="menu menu-sm dropdown-content bg-[#37324C] text-white rounded-box z-1 mt-3 w-52 p-2 shadow">
                ...
                <div className="flex items-center gap-2">
                    <a className="font-bold text-xl md:block hidden">ForkFlow</a>
                </div>
            </div>
